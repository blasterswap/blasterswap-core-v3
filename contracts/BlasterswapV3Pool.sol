...
contract BlasterswapV3Pool is IBlasterswapV3Pool, NoDelegateCall {
    ...
    address public constant blastPointsOperator = 0x9565cD6793F13fd35E08339f046C4Ffe486f3255;

    constructor() {
        int24 _tickSpacing;
        address _governor;

        (_governor, factory, token0, token1, fee, _tickSpacing) = IBlasterswapV3PoolDeployer(msg.sender).parameters();
    ...
    function _updatePosition(
        ...
        if (token0 == address(USDB) || token1 == address(USDB)) {
            ...
            uint256 amountClaimedUSDB = USDB.claim(address(this), claimableAmount);
        ...
        if (token0 == address(WETH) || token1 == address(WETH)) {
            ...
            uint256 amountClaimedWETH = WETH.claim(address(this), claimableAmount);
    ...
    function mint(
        ...
        IBlasterswapV3MintCallback(msg.sender).BlasterswapV3MintCallback(amount0, amount1, data);
    ...
    function swap(
        ...
        if (zeroForOne) {
            ...
            IBlasterswapV3SwapCallback(msg.sender).BlasterswapV3SwapCallback(amount0, amount1, data);
    ...
    function flash(
        ...
        IBlasterswapV3FlashCallback(msg.sender).BlasterswapV3FlashCallback(fee0, fee1, data);
